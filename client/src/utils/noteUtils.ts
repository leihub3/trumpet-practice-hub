...
const noteFrequenciesFlats = {
  ...
  'C8': 4186.01, 'Db8': 4434.92, 'D8': 4698.64, 'Eb8': 4978.03, 'E8': 5274.04, 'F8': 5587.65, 'Gb8': 5919.91, 'G8': 6271.93, 'Ab8': 6644.88, 'A8': 7040.00, 'Bb8': 7458.62, 'B8': 7902.13,
};

export function getUpdatedFrequencies(newA4: number, useSharps: boolean = true) {
...
export function getNoteInfo(frequency: number, useSharps: boolean = true, a4Frequency: number = 440) {

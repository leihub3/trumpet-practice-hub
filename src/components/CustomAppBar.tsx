...
const CustomAppBar: React.FC<CustomAppBarProps> = ({ open, user, handleDrawerOpen, handleLogin, handleLogout }) => {
  return (
    <AppBar position="fixed" open={open} user={user} handleDrawerOpen={handleDrawerOpen} handleLogin={handleLogin} handleLogout={handleLogout}>
      <Toolbar>
        <IconButton
          color="inherit"
